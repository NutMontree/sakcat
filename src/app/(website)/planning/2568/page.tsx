...
export default function Plan2568() {
  // 1. แยกข้อมูลไฟล์ออกมาเป็น Array เพื่อให้จัดการง่าย
  const documents = [
    {
      name: "รายงานผลการดำเนินโครงการ ประจำปีงบประมาณ 2568",
      href: "/pdf/งานวางแผน/2568/รายงานผลการดำเนินโครงการประจำปีงบประมาณ2568.pdf",
    },
    {
      name: "แผนปฏิบัติราชการ ประจำปีงบประมาณ 2568",
      href: "/pdf/งานวางแผน/2568/แผนปฏิบัติราชการประจำปีงบประมาณ2568.pdf",
    },
  ];
