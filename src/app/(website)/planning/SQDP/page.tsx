...
export default function SQDP() {
  // 1. แยกข้อมูลไฟล์ออกมาเป็น Array เพื่อให้จัดการง่าย
  const documents = [
    {
      name: "แผนพัฒนาคุณภาพสถานศึกษา (พ.ศ.2565–2569) ฉบับสมบูรณ์",
      href: "/pdf/งานวางแผน/แผนพัฒนาคุณภาพสถานศึกษา(พ.ศ.2565–2569).pdf",
    },
    {
      name: "แผนพัฒนาสถานศึกษา ระยะ 5 ปี (พ.ศ.2567-2571)",
      href: "/pdf/งานวางแผน/แผนพัฒนาสถานศึกษาระยะ5ปี(พ.ศ.2567-2571).pdf",
    },
  ];
