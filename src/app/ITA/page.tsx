...
const IndicatorItem = ({ item, dbItems, onViewImage }: { item: any; dbItems: any[]; onViewImage: (url: string, name: string) => void }) => {
...
const CategorySection = ({ group, dbItems, onViewImage }: { group: any; dbItems: any[]; onViewImage: (url: string, name: string) => void }) => {
  return (
      ...
      return [
        {
          ...
          items: [
            ...
            },
            {
              ...
              guideline: "แสดงหน้าที่และอำนาจตามกฎหมายจัดตั้ง หรือกฎหมายอื่นที่เกี่ยวข้องในการจัดตั้งสถานศึกษา",
              responsibility: "งานบริหารทั่วไป/งานบุคลากร",
            },
            {
              key: "4",
            ...
            },
            {
              ...
              guideline: "แสดงกฎหมาย พระราชบัญญัติ ระเบียบ ข้อบังคับ หรือระเบียบการดำเนินการที่เกี่ยวข้อง",
              responsibility: "งานบริหารทั่วไป/งานบุคลากร",
            },
          ],
        },
          ...
          items: [
            {
              ...
              guideline: "แสดงข่าวประชาสัมพันธ์ กิจกรรม ข้อมูลความเคลื่อนไหว และการดำเนินงานตามภารกิจหลัก",
              responsibility: "งานศูนย์ข้อมูล/งานประชาสัมพันธ์",
            },
            {
              key: "8",
              ...
              guideline: "ช่องทางที่บุคคลภายนอกสามารถสอบถามข้อมูล แลกเปลี่ยนความเห็น (เช่น Webboard หรือ Live Chat)",
              responsibility: "งานศูนย์ข้อมูล/งานประชาสัมพันธ์",
            },
            {
              key: "9",
              ...
              guideline: "แสดงช่องทางเครือข่ายสังคมออนไลน์หลักของวิทยาลัย เช่น Facebook, YouTube, Line",
              responsibility: "งานศูนย์ข้อมูล",
            },
            {
              key: "10",
            ...
            },
            {
              ...
              guideline: "แสดงรายงานการประเมินตนเอง สรุปงบประมาณ หรือผลการดำเนินงานประจำปีที่ผ่านมา",
              responsibility: "งานวางแผนและงบประมาณ",
            },
            {
              key: "12",
            ...
            },
            {
              ...
              guideline: "สถิติจำนวนผู้มาขอรับบริการ หรือรายงานผลสรุปการรับใช้บริการอย่างเป็นรูปธรรม",
              responsibility: "งานศูนย์ข้อมูล",
            },
            {
              key: "15",
            ...
            },
            {
              ...
              guideline: "ช่องทางออนไลน์ หรือหน้าเว็บเพจอำนวยความสะดวกบริการประชาชนโดยไม่ต้องเข้ามาสถานศึกษา",
              responsibility: "งานศูนย์ข้อมูล",
            },
          ],
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              guideline: "รายงานการรับ-จ่ายเงิน หรือรายงานวิเคราะห์งบการเงินการใช้จ่ายงบประมาณของโครงการ",
              responsibility: "งานวางแผนและงบประมาณ",
            },
            {
              key: "19",
            ...
            },
            {
              ...
              guideline: "สรุปรายงานการประเมินและการวิเคราะห์ปัญหาความเสี่ยงในการจัดซื้อจัดจ้างปีงบประมาณปีก่อน",
              responsibility: "งานพัสดุ",
            },
          ],
        },
          ...
          items: [
            {
              ...
              guideline: "คู่มือหรือข้อกำหนดแนวทางการจัดการเรื่องร้องเรียนกรณีพบการทุจริตประพฤติมิชอบ",
              responsibility: "งานบริหารทั่วไป",
            },
            {
              key: "27",
            ...
            },
            {
              ...
              guideline: "สถิติจำนวนเรื่องร้องเรียน ข้อคิดเห็น และผลสรุปความคืบหน้าการแก้ปัญหาเรื่องทุจริต",
              responsibility: "งานบริหารทั่วไป",
            },
            {
              key: "29",
              ...
              guideline: "รายงานกิจกรรมความร่วมมือและการมีส่วนร่วมของเครือข่ายหรือชุมชนภายนอกในการพัฒนา",
              responsibility: "งานบริหารทั่วไป",
            },
          ],
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              guideline: "การวิเคราะห์และรายงานผลการวิจัย/ประเมินผลระบบควบคุมการบริหารลดความเสี่ยงทุจริต",
              responsibility: "งานบริหารทั่วไป",
            },
            {
              key: "33",
            ...
            },
            {
              ...
              guideline: "แผนปฏิบัติการการป้องกันความทุจริตและยกระดับคุณธรรมจริยธรรมประจำปีงบประมาณ",
              responsibility: "งานวางแผนและงบประมาณ",
            },
            {
              key: "35",
          ...
          items: [
            {
              ...
              guideline: "มาตรการที่กำหนดกระบวนการทำงานเพื่อความโปร่งใส คุ้มครองผู้ร้องเรียน หรือการเผยแพร่ความโปร่งใส",
              responsibility: "งานบริหารทั่วไป",
            },
            {
              key: "37",
      ...
      {activeImageUrl && (
        ...
        >
          ...
          <button
            ...
            title="ปิดรูปภาพ"
          >
            <span className="text-lg font-black leading-none w-4 h-4 flex items-center justify-center">✕</span>
          </button>
