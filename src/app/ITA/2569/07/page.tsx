    ...
    <>
      ...
      <div className="grid gap-4 py-4">
        <div className="hover:text-blue-500 dark:hover:text-blue-400">
          <LinkPreview url="https://sakcat.ac.th/pressrelease">
        ...
        <div className="hover:text-blue-500 dark:hover:text-blue-400">
          <LinkPreview url="https://sakcat.ac.th/newsletter">
            <p className="text-3 md:text-3.5 hover:text-orange-500 sm:text-sm md:text-base dark:hover:text-orange-400">
              2. จดหมายข่าว
            </p>
          </LinkPreview>
        ...
        <div className="hover:text-blue-500 dark:hover:text-blue-400">
          <LinkPreview url="https://sakcat.ac.th/announcement">
            <p className="text-3 md:text-3.5 hover:text-orange-500 sm:text-sm md:text-base dark:hover:text-orange-400">
              3. ข่าวประกาศ
            </p>
          </LinkPreview>
        ...
        <div className="hover:text-blue-500 dark:hover:text-blue-400">
          <LinkPreview url="https://sakcat.ac.th/bidding">
            <p className="text-3 md:text-3.5 hover:text-orange-500 sm:text-sm md:text-base dark:hover:text-orange-400">
              4. ข่าวประกวดราคา
            </p>
          </LinkPreview>
        ...
        <div className="hover:text-blue-500 dark:hover:text-blue-400">
          <LinkPreview url="https://sakcat.ac.th/technicalcollegeorders">
            <p className="text-3 md:text-3.5 hover:text-orange-500 sm:text-sm md:text-base dark:hover:text-orange-400">
